                ...
                if "(mode=" in key[1]:
                    if key[1] == "(mode=debug)":
                        try:
                            try:
                                cmd.replace("run","")
                                os.system(f"python E:/enchant/sbin/InfinitiSmartFramework/Framework/ScriptingLanguages/pluto/sbin/pmDEBUG.py {key[2]}")
                    ...
                    try:
                        try:
                            cmd.replace("run","")
                            os.system(f"python E:/enchant/sbin/InfinitiSmartFramework/Framework/ScriptingLanguages/pluto/sbin/pmRUN.py {key[1]}")
                        except Exception as exx:
                            out.error(exx)
                    except Exception as exx:
                        out.error(exx)      
                    ...
                    if key[1] == "(mode=debug)":
                        try:
                            try:
                                ...
                                if pathtofile:
                                    os.system(f"python E:/enchant/sbin/InfinitiSmartFramework/Framework/ScriptingLanguages/pluto/sbin/pmDEBUG.py {pathtofile}")
                            except Exception as exx:
                                out.error(exx)
                        except Exception as exx:
                            out.error(exx)
                            ...
                            try:
                                ...
                                for _ in script_names:
                                    if key[2] == _:
                                        ...
                                        pathtofile = data["scripts"][_]
                                if pathtofile:
                                    os.system(f"python E:/enchant/sbin/InfinitiSmartFramework/Framework/ScriptingLanguages/pluto/sbin/pmRUN.py {pathtofile}")
                            except Exception as exx:
                                out.error(exx)
                        except Exception as exx:
                            out.error(exx)
