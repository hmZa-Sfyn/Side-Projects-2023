...
code = """
CREATE Alice secretpassword 1000; DEPOSIT Alice 500; WITHDRAW Alice 200; BALANCE Alice;
LOCK Alice; UNLOCK Alice; BLOCK Alice; UNBLOCK Alice; FREEZE Alice; UNFREEZE Alice;
